...
class QuickLogScrollViewTests: XCTestCase {
    ...
    func test_DataEntryTableView_AfterScrollViewDisplayed_IsNotNil() {
        XCTAssertNotNil(sut.dataEntryTableView)
    }
    
    func test_DataEntryTableView_IsDescendantOfScrollView() {
        XCTAssertTrue(sut.dataEntryTableView.isDescendant(of: sut))
    }
    ...
    func test_AddIntervalButton_IsDescendantOfScrollView() {
